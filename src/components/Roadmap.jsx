...
const Roadmap = () => (
  <Section className="overflow-hidden" id="roadmap">
    <div className="container md:pb-10">
      <Heading tag="Ready to get started" title="Main Features" />
      ...
      <div className="mt-16 mb-10 px-8 py-10 bg-n-7/70 rounded-2xl shadow-lg max-w-5xl mx-auto border border-n-4/30 backdrop-blur-sm" id="contact-us">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-n-4">
          <li className="flex items-center gap-3">
            ...
            <a href="mailto:Gobezacademy5@gmail.com" className="text-blue-500 hover:underline flex items-center gap-1">
          ...
          <li className="flex items-center gap-3">
            ...
            <a href="tel:+251990909033" className="text-blue-500 hover:underline flex items-center gap-1">
          ...
          <li className="flex items-center gap-3">
            ...
            <a href="https://t.me/Gobezacademyapp" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline flex items-center gap-1">
          ...
          <li className="flex items-center gap-3">
            ...
            <a href="https://wa.me/251990909033" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline flex items-center gap-1">
          ...
          <li className="flex items-center gap-3">
            ...
            <span>Bethel, Addis Ababa, Ethiopia</span>
          </li>
        </ul>
      </div>
